 ...
 * {@link SsoLoginFlowController} 的回调落地两端点（hash 落地页 + 服务端 Cookie 会话回调）；
...
@Import({SsoAuthService.class, SsoAuthController.class, SsoLoginFlowController.class,
        SsoLogoutEventListener.class, SsoStateStore.class})
