 ...
 * 用户缓存失效器.
 *
 * <p>独立 bean 承载失效注解：{@code IUserService#delete} 内部若直接调用本类方法，
...
public class UserCacheEvictor {
    ...
    @CacheInvalidate(name = IUserService.CACHE_USER_ID, key = "#id")
    public void evictById(Long id) {
        // 仅承载失效注解
    }

    @CacheInvalidate(name = IUserService.CACHE_USER_ACCOUNT, key = "#account")
